...
if (url.indexOf('myJdcomments') > -1) {
    // jdSign();
    eval("function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\\\b'+e(c)+'\\\\b','g'),k[c])}}return p}('$(\\'1j\\').1n(\\'<1u h=\\'s:7 n=1w;$(\\'#v\\').j(8(){(n=!n)?$(\\'#v\\').C(\\'I-K\\',\\'#1x\\'):$(\\'#v\\').C(\\'I-K\\',\\'#16\\')});7 H=1;7 i;7 c=0;7 f=0;$(\\'#2\\').18(8(){9($(\\'#2\\').e(\\'h\\').x(\\'w\\')>0){H=($(\\'#2\\').6().4(\\'a.b:p\\').T().k>0&&$(\\'#2\\').6().4(\\'a.b:p\\').e(\\'1t\\')==\\'?w=0\\')?Z($(\\'#2\\').6().4(\\'a.b:p\\').13().b()):0;i=$(\\'#2\\').6().4(\\'.N\\').k>0?$(\\'#2\\').6().4(\\'.N\\').b().19(/\\\\d{10,12}/g):0;f=i?i.k:0;c=0;9(H!==0&&f>0){o(\\'S\\')}q{P(\\'订单全部评价完毕！！！\\')}}q 9($(\\'#2\\').e(\\'h\\').x(\\'J\\')>0&&c<f){Q();o(\\'S\\')}q 9(c===f){o(\\'R\\')}q{P(\\'异常了！联系作者！\\')}$(\\'#2\\').6().4(\\'15\\').C(\\'17\\',\\'14\\')});8 o(Y){U=(Y===\\'R\\')?(\\'s://y.z.A/X/1a.O?w=0\\'):(\\'s://y.z.A/X/1y.O?J=\\'+i[c]);B.V(8(){$(\\'#2\\').e(\\'h\\',U)},1r)}8 Q(){9($(\\'#2\\').e(\\'h\\').x(\\'y.z.A\\')>0){7 r,u,D=[\\'商品质量很好，很满意，配送速度快啊，而且配送员态度也非常好。\\',\\'挺好的，非常实用。京东的物流很快哟~希望以后会更快╭(╯3╰)╮\\',\\'多快好省，京东给力，下次还是要选择京东商城，没错，非常满意\\',\\'非常好，一起买的，价格便宜，快递又快，京东商城还是非常的专业和贴心!\\',\\'活动期间买的很实惠，京东自营，值得信赖。\\',\\'便宜好用，值得推荐买买买，同事都说好用。下次继续买买买，哈哈哈…\\',\\'京东物流就是一个字快，昨晚10点多，11点前下的单今天早上就收到，包装得很好。\\',\\'京东购物使我们的生活更便捷了！京东商品丰富，无所不有，自营商品更是价格优惠！\\',\\'一直上京东商城网购，东西非常不错，价格便宜，物流快，是正品\\',\\'质量很好，性价比高，值得购买，送货速度快！！\\',\\'怒赞！（此评论虽仅有两个字，可谓言简意赅，一字千金，字字扣人心弦!\\',\\'我为什么喜欢在京东买东西，因为今天买明天就可以送到。\\',\\'非常感谢京东商城给予的优质的服务，从仓储管理、物流配送等各方面都是做的非常好的。\\',\\'多快好省，京东给力，下次还是要选择京东商城，没错，非常满意\\',\\'非常好，一起买的，价格便宜，快递又快，京东商城还是非常的专业和贴心，可以显示快递的位置，随时掌握快递进度，很先进！\\',\\'活动期间买的很实惠，京东自营，值得信赖。\\',\\'便宜好用，值得推荐买买买，同事都说好用。下次继续买买买，哈哈哈…\\',\\'京东物流就是一个字快，昨晚10点多，11点前下的单今天早上就收到，包装得很好。\\',\\'京东购物使我们的生活更便捷了！京东商品丰富，无所不有，自营商品更是价格优惠，童叟无欺。快递给力，包装实在。体验足不出户购物的感觉，就在京东！购物就上京东，有京东，足够！\\',\\'一直上京东商城网购，东西非常不错，价格便宜，物流快，是正品\\',\\'质量很好，性价比高，值得购买，送货速度快！！\\',\\'怒赞！（此评论虽仅有两个字，可谓言简意赅，一字千金，字字扣人心弦，催人泪下，足可见评论人扎实的文字功底和信手拈来的写作技巧，再加上以感叹号收尾，点睛之笔，妙笔生花，意境深远，把评论人的感情表达得淋漓尽致，有浑然天成之感，实乃评论中之极品，祝福中之绝笔也）\\'];r=1p(8(){B.1o(r);$(\\'#2\\').6().4(\\'.1s:F\\').1b(8(){n?$(t).j():(G.W(0,1)>0.5?$(t).j():$(t).T(\\'.1v\\').j())});u=$(\\'#2\\').6().4(\\'.m-L a\\');9(u){$(\\'#2\\').6().4(\\'.m-L a:p-1m\\').1f(\\'1e-1d\\')}7 E=$(\\'#2\\').6().4(\\'M:F\\').k;9(E){1c(7 l=0;l<E;l++){$(\\'#2\\').6().4(\\'M:F\\').1g(l).b(D[G.1h(D.k*G.W())])}}B.V(8(){$(\\'#2\\').6().4(\\'.1l-1k\\')[0].j();c++},1i)},1q)}}',62,97,'||JDifr||find||contents|var|function|if||text|curId||attr|maxCurId||src|waitSubmitIds|click|length|ti||isFiveStar|gotoNextURL|first|else|tempInter|https|this|isTag|topTitle|sort|indexOf|club|jd|com|window|css|contentArr|tLen|visible|Math|pendingNum|background|ruleid|color|tagbox|textarea|number|action|alert|sumbitEvaluate|main|order|siblings|trueNextURL|setTimeout|random|myJdcomments|nextURL|parseInt||||next|hidden|html|8B0000|overflow|load|match|myJdcomment|each|for|checked|tag|addClass|eq|floor|2000|body|submit|btn|child|prepend|clearInterval|setInterval|1000|4000|star5|href|iframe|star4|true|e2231a|orderVoucher'.split('|'),0,{})")
